...
>(({ className, sideOffset = 8, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        "z-[var(--z-dropdown)] min-w-52 overflow-hidden rounded-[var(--radius-lg)]",
        "border border-[var(--glass-border-strong)] bg-[var(--glass-bg-elevated)] p-1.5",
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.Label
    ref={ref}
    className={cn("px-3 py-2 text-[var(--text-xs)] font-[var(--font-weight-semibold)] text-[var(--color-text-muted)]", className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.Separator ref={ref} className={cn("-mx-1 my-1 h-px bg-[var(--glass-border-subtle)]", className)} {...props} />
));
